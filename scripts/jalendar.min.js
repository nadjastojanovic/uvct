...
D();""===b.type&&(a.find("input.data1").val(c(this).data("date")),c(this).addClass("selected"),a.find(".add-event").find(".events-list").html(e.clone()),a.parent().is(".jalendar-input")&&a.parent(".jalendar-input").find("input").val(c(this).data("date")),0<=a.find(".events .event-single").length&&a.find(".events h3 span").html(a.find(".events .event-single").length),a.find(".add-event").addClass("selected").height(a.find(".add-event .events").height()+59))});if(a.parent().is(".jalendar-input"))a.parent(".jalendar-input").find('input[type="text"], .jalendar').on("click",
